"""
Django settings for sma_project project.
...
SECRET_KEY = 'django-insecure-hh19qden$xbqw-y%^d5)4@$q%sbr-s^@7pw1q-@_=&6oj^b#ct'
...
# For use during development. Need to replace with real e-mail server for production.
